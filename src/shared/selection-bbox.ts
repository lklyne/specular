 ...
 * in the given coordinate space. Groups are skipped — they own a separate
 * selection overlay, not the multi-bbox. Returns null when fewer than two
 * matching non-group entities are found (multi-bbox is a 2+-entity concept;
