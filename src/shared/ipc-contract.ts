...
export interface IpcContract {
  ...
  'canvas-move-annotation': { dir: 'renderer→main'; payload: unknown }
  'canvas-move-annotation-begin': { dir: 'renderer→main'; payload: unknown }
  'canvas-move-annotation-end': { dir: 'renderer→main'; payload: unknown }
...
export const ipcChannels = {
  ...
  canvasMoveAnnotation: 'canvas-move-annotation',
  canvasMoveAnnotationBegin: 'canvas-move-annotation-begin',
  canvasMoveAnnotationEnd: 'canvas-move-annotation-end',
  ...
  setShowAllNodes: 'set-show-all-nodes',
