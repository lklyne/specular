...
function popupClass(isDark: boolean): string {
  ...
  return isDark
    ? `${base} border-zinc-700 bg-zinc-900 text-[var(--surface-foreground)]`
    : `${base} border-zinc-200 bg-white text-[var(--surface-foreground)]`
}
...
function inputClass(isDark: boolean): string {
  ...
  return isDark
    ? `${base} border-zinc-700 text-[var(--surface-foreground)] focus:border-zinc-500`
    : `${base} border-zinc-300 text-[var(--surface-foreground)] focus:border-zinc-500`
}
