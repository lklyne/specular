...
**Status:** Accepted — landed 2026-05-12 as part of the Keyboard binding registry (#76). `keyboard-shortcuts.ts` deleted; replaced by `src/shared/bindings.ts` (registry + dispatch logic), `src/main/runtime/binding-dispatcher.ts` (main-process driver), and `src/main/runtime/binding-handlers.ts` (action implementations).
**Date:** 2026-05-12
