...
**Status:** Accepted
**Date:** 2026-05-11
**Implementation:** Slices 1–4 ✅ landed (pure math, sidebar sort, page WCV re-stack, aboveView paint order). Slices 5–9 (sidebar drag-to-reorder, keyboard shortcuts, edges in entityOrder, migration, HTTP routes) pending.
