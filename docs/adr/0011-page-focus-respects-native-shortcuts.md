...
**Status:** Accepted — landed with ADR 0010. `firesFromPageFocus: true` in `src/shared/bindings.ts` gates which bindings can fire when `pageFocusActive` is set; all others pass through to the page.
**Date:** 2026-05-12
