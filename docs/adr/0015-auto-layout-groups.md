...
**Status:** Accepted — Milestones 1 and 2 landed. `managedLayout`, `layoutMode`, and `layoutGap` are all live; `managed-layout.ts` owns reflow. Gap handles and column mode are in production.
**Date:** 2026-05-29
