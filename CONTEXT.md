...
The generic "hook to a page" utility ([ADR 0029](./docs/adr/0029-page-anchored-entities.md), `src/shared/page-anchor.ts`). A canvas item is either **free-form / canvas-bound** (default) or carries a `PageAnchor { pageId, pageUrl? }`. Consumers today: `text` (stickies), `drawing`, `shape`, and annotations (§Annotations).
